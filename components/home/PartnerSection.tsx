    ...
    return (
        <section className="relative w-full px-10 py-14">
            ...
            <div className="flex flex-row mt-6 mx-auto justify-center items-center gap-x-8 max-w-6xl">
                ...
                <BoxCard>
                    <BoxImage className="w-60 pt-16 pb-3" src="img/partners/flightsimto.png" alt="Sim4flight" />
                    <BoxBody>
                ...
                <BoxCard>
                    <BoxImage className="w-60 pt-14 " src="img/partners/fsnews.png" alt="Sim4flight" />
                    <BoxBody>
