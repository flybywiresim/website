...
const BrandingPaletteColor: React.FC<BrandingColourProps> = (props) => (
    <div>
        ...
        <p><b>HEX&nbsp;</b>{props.hex}</p>
        <p><b>RGB&nbsp;</b>{props.rgb}</p>
        <p><b>HSV&nbsp;</b>{props.hsv}</p>
    </div>
);
    ...
    <section className="w-screen px-4 pb-8 bg-gray-900">
        <div className="mx-auto pt-40 max-w-7xl">
            <div className="max-w-prose space-y-4">
                ...
                <p className="text-lg tracking-wide">Please use the provided logos on the download part of this page, follow our guidelines wherever possible and we have some examples of refrain from.</p>
            </div>
            ...
            <div className="mt-12 bg-blue-dark-contrast">
                ...
                <div className="py-10 mx-4 grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {BadBrandingList.map(x =>
                        <BrandingItemExample key={x.name} name={x.name} src={x.src} desc={x.desc} />
                    )}
                </div>
            </div>
            ...
            <div className="justify-between mt-12 flex flex-col md:flex-row">
                <div>
                    ...
                    <p className="max-w-prose text-lg py-3">All of the officially approved logos and variations can be found&nbsp;
                        <a href="https://github.com/flybywiresim/fbw-branding"
                            rel="noreferrer"
                            target="_blank"
                    ...
                    <div className="py-5">
                        ...
                        <p className="max-w-prose text-lg py-3 mx-4">
                            <li>Aileron Font -&nbsp;
                                <a href="https://www.1001fonts.com/aileron-font.html"
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-teal-900">
                                Download
                ...
                <div>
                    ...
                    <div className="flex flex-row my-3 space-x-8">
                        {BrandingColors.map(x =>
                            <BrandingPaletteColor key={x.name} name={x.name} hex={x.hex} rgb={x.rgb} hsv={x.hsv} />
                        )}
                    </div>
                </div>
            </div>
