            ...
            <Container className="p-4">
                <div className="flex justify-between space-x-4">
                    ...
                    <span className="flex flex-col place-content-center w-7 h-10 transition cursor-pointer md:hidden" onClick={() => setOpen(!isOpen)}>
                        <div className={`${isOpen && 'rotate-45 translate-y-1'} duration-200 h-1 bg-white rounded-full`} />
                        <div className={`${isOpen ? 'h-0' : 'h-1 my-1'} bg-white rounded-full`} />
                        <div className={`${isOpen && '-rotate-45'}  duration-200 h-1 bg-white rounded-full`} />
                    </span>
