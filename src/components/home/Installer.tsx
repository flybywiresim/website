...
export const Installer = forwardRef(() => (
    <section ref={installerRef} className="relative w-screen flex flex-col 3xl:flex-row 3xl:justify-center items-center px-page py-6 overflow-hidden bg-blue-dark">
        <div className="mt-10 max-w-2xl flex flex-col items-center 3xl:items-start text-center 3xl:text-left mb-4 3xl:mb-20 3xl:mr-12 space-y-4">
            ...
            <a href="https://api.flybywiresim.com/installer">
                <Button className="w-40 mt-4 bg-teal-light-contrast border-2 border-teal-light-contrast hover:bg-white hover:text-teal-light-contrast font-bold">
                    Download
                </Button>
            </a>
        </div>
