                ...
                <Container>
                    <div className="grid gap-8">
                        ...
                        <div>
                            ...
                            <p>
                                The A32NX includes a custom flight management system, developed to precisely match the behaviour and
                                quirks of the real Honeywell H3 FMS found on the A320 family.
                            </p>
                        </div>
                    </div>
                </Container>
